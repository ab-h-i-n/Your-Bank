...
function WithdrawModal({children,openModal,setOpenModal}) {
      ...
      <Modal className='bg-[#000000] backdrop-blur-sm' show={openModal} size="md" onClose={onCloseModal} popup>
        ...
        <Modal.Body className='bg-[#191919] overflow-x-hidden'>
          <div className="space-y-6">
            <SectionHnD textWhite={"Withdraw"} textGreen={"Money"} Description={"Withdraw money to your account"} />
            <div>
              <div className="mb-2 block ">
                <Label htmlFor="amount" value="Amount to Withdraw" className='text-white' />
              </div>
            ...
            <div className="w-full flex justify-center">
              <button className='bg-[#CAFF33] text-[#191919] hover:bg-[#efffc2] font-medium py-2 px-3 rounded'>Withdraw</button>
            </div>
          </div>
        </Modal.Body>
      </Modal>
